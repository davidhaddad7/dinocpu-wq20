...
class PipelinedCPU(implicit val conf: CPUConfig) extends BaseCPU {
  ...
  // Insert the ALU inpux mux here (line 57 of single-cycle/cpu.scala)
  ...
  // Set data memory IO (line 69 of single-cycle/cpu.scala)
  ...
  // Set the writeback data mux (line 82 single-cycle/cpu.scala)
